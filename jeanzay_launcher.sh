#!/bin/bash
#SBATCH --job-name=star-ddpm-2class-test # nom du job
...
--labels pipelines    --batch_size 1 --data_dir data --sample_dir samples-2classes-2 \
...
#    --n_epoch 500 --lrate 1e-4 --sample_dir samples-2classes-2 --save_dir models-2classes-2
